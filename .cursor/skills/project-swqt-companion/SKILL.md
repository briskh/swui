...
- Local / source (2026-07-24): `@swqt/ui` and local swui MCP source are **1.2.0**; `@swqt/ui-tokens` remains **1.1.0**. DescriptionList detail-field exports shipped. Packed consumers for `1.2.0` nested and hoisted each **34 passed / 6 declared skips**.
- npm registry (2026-07-24 post-publish, after CDN lag): `@swqt/ui@1.2.0` (`dist-tag latest`); `@swqt/ui-tokens@1.1.0` unchanged.
