  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        weekday: cn("w-control-sm text-center text-[0.8rem] font-normal text-muted-foreground", defaults.weekday),
        week: cn("mt-2 flex w-full", defaults.week),
        day: cn(
          "relative h-control-sm w-control-sm p-0 text-center text-sm focus-within:relative focus-within:z-20 [&:has([aria-selected])]:bg-accent",
          defaults.day
        ),
        day_button: cn(
          buttonVariants({ variant: "ghost" }),
          "size-control-sm p-0 font-normal aria-selected:opacity-100",
          defaults.day_button
        ),
