...
| Axis | Contract |
|------|----------|
| Runtime (organization apps) | **light-only**. Do not mount `.dark` until upstream re-enables dual-theme. |
...
| `--accent-foreground` | `oklch(0.24 0.05 65)` | `oklch(0.58 0.20 90)` | On accent |
| `--destructive` | `oklch(0.58 0.17 32)` | `oklch(0.68 0.16 32)` | Errors |
...
| `--status-error` | `oklch(0.58 0.17 32)` | `oklch(0.72 0.15 32)` | Failed |
