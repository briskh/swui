...
- [R-SWUI-001 — Theme consistency governance research](R-SWUI-001-theme-consistency-governance-research.md) — Feature 输入：主题、尺寸、组件运行时与消费端治理。
- [R-SWUI-002 — Design system portal, Agent MCP, and npm registry integration](R-SWUI-002-design-system-portal-mcp-registry-research.md) — 库来源、展示站、MCP 查询与私有 registry 集成（方案 A）。
